...
/* handleBeginTrackingFromDialog removed.
   Tracking dialog ownership and orchestration has been moved to AppController.
   MainWindow no longer implements this handler.
*/
